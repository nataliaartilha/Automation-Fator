        ...
        while operacao<linhas:
                if df.loc[df.index[operacao],'Indexador']=="CDI":
                        ...
                        try:
                                ...
                                WebDriverWait(driver, 100).until(EC.element_to_be_clickable((By.XPATH, '//*[@id="popup-blockUI"]/div[1]/button'))).click()
                                ...
                                #prazo1="54"
                                #driver.find_element(By.ID,'INPrazoMatriz').send_keys(prazo3)
                                ...
                                driver.execute_script("window.scrollTo(0,document.body.scrollHeight)")
                                time.sleep(1)
                                WebDriverWait(driver, 60).until(EC.element_to_be_clickable((By.NAME, 'salvar'))).click()
                                ...
                                try:
                                        WebDriverWait(driver, 60).until(EC.element_to_be_clickable((By.XPATH, '//*[@id="btnConfirmar"]'))).click()
                                #time.sleep(5)
                                except:
                                        time.sleep(2)
                                        driver.find_element(By.NAME,'confirmar').click() 
                                ...
                                #WebDriverWait(driver, 60).until(EC.element_to_be_clickable((By.XPATH, '//*[@id="popup-blockUI"]/div[1]/button'))).click()
                                #driver.find_element(By.XPATH,'//*[@id="popup-blockUI"]/div[1]/button').click()
                                #operacao=operacao+1
        #//*[@id="btnConfirmar"]
        #<button type="button" class="close" onclick="$.unblockUI(); return false;">
                                        #<span aria-hidden="true">×</span><span class="sr-only">Close</span>
                                #</button>
        #//*[@id="popup-blockUI"]/div[1]/button
        #salvar
        #//*[@id="boletaForm"]/div[13]/input[1]
                        except:
                                driver.get("https://boletador.fator.com.br/BoletaRendaFixaEM/InserirAplicacao/Aplicacao")
